...
static const char *Help_GetRTF(HelpTopic topic)
{
    ...
    case HELP_RUNNING_SCRIPTS:
        return "{\\rtf1\\ansi\\deff0"
            ...
            "{\\b Console Options}\\par"
            "Configurable in Settings:\\par"
    ...
    case HELP_SOURCES:
        return "{\\rtf1\\ansi\\deff0"
            ...
            "{\\b Additional GitHub Repositories}\\par"
    ...
    case HELP_UPDATE_DEPS:
        return "{\\rtf1\\ansi\\deff0"
            ...
            "{\\b Adding Dependencies to Your Scripts}\\par"
